      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center">
            <div className="flex items-center bg-[#161616] rounded-full p-1.5 border border-[#262626]">
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 bg-linear-to-r from-orange-500 to-orange-600 text-white"
              ...
              <NavLink
                ...
                to="/blog"
                data-discover="true"
                onClick={() => setFilter("جميع المقالات")}
              >
                المدونة
              </NavLink>
              <NavLink
          ...
          <div className="hidden md:flex items-center gap-3 group">
            <button className="p-3 cursor-pointer text-neutral-500 hover:text-orange-500 hover:bg-[#161616] rounded-xl transition-all duration-300 border border-transparent hover:border-[#262626]">
              <svg
                className="w-5 h-5"
                fill="none"
                stroke="currentColor"
